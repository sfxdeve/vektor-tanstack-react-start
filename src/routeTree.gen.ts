...
import { Route as AuthedPaymentStatusRouteImport } from './routes/_authed/payment.$status'
...
const AuthedPaymentStatusRoute = AuthedPaymentStatusRouteImport.update({
  id: '/payment/$status',
  path: '/payment/$status',
  getParentRoute: () => AuthedRouteRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/payment/$status': typeof AuthedPaymentStatusRoute
...
export interface FileRoutesById {
  ...
  '/admin/users': typeof AdminUsersRoute
  '/admin/': typeof AdminIndexRoute
  '/_authed/payment/$status': typeof AuthedPaymentStatusRoute
  '/api/admin/companies': typeof ApiAdminCompaniesRouteWithChildren
  '/api/admin/stats': typeof ApiAdminStatsRoute
  '/api/admin/users': typeof ApiAdminUsersRouteWithChildren
  '/api/auth/$': typeof ApiAuthSplatRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authed/payment/$status': {
      id: '/_authed/payment/$status'
      path: '/payment/$status'
      fullPath: '/payment/$status'
      preLoaderRoute: typeof AuthedPaymentStatusRouteImport
      parentRoute: typeof AuthedRouteRoute
    }
    '/api/admin/companies': {
      id: '/api/admin/companies'
...
interface AuthedRouteRouteChildren {
  ...
  AuthedPaymentStatusRoute: typeof AuthedPaymentStatusRoute
}
...
const AuthedRouteRouteChildren: AuthedRouteRouteChildren = {
  ...
  AuthedPaymentStatusRoute: AuthedPaymentStatusRoute,
}
