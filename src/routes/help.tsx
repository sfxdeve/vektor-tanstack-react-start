            ...
            >
              <div className="relative bg-zinc-950">
                <img
                  src={slide.image}
                  alt={slide.title}
                  className="h-[240px] w-full object-cover object-top opacity-95"
          ...
          <div className="mt-3 overflow-x-auto">
            <table className="w-full border border-zinc-200 text-sm">
              ...
              <tbody className="divide-y divide-zinc-100">
                ...
                <tr>
                  <td className="px-3 py-2 font-mono" rowSpan={5}>
                    GB
                  </td>
                  <td className="px-3 py-2">
                    <a
                  ...
                  <td className="px-3 py-2 text-zinc-600">Western Cape</td>
                </tr>
                <tr>
                  <td className="px-3 py-2">
                    <a
                  ...
                  <td className="px-3 py-2 text-zinc-600">Southern &amp; Eastern Cape</td>
                </tr>
                <tr>
                  <td className="px-3 py-2">BIBC (East London)</td>
                  <td className="px-3 py-2 text-zinc-600">East London / Border</td>
                </tr>
                <tr>
                  <td className="px-3 py-2">BIBC (Kimberley)</td>
                  <td className="px-3 py-2 text-zinc-600">Kimberley / Northern Cape</td>
                </tr>
                <tr>
                  <td className="px-3 py-2">BCBI (Bloemfontein)</td>
                  <td className="px-3 py-2 text-zinc-600">Bloemfontein / Free State</td>
                </tr>
              </tbody>
            </table>
          </div>
