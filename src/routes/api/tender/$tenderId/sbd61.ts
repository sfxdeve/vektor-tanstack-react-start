  ...
  server: {
    handlers: {
      GET: async ({ request, params }) => {
        ...
        const preferenceSystem = tender.preferencePointSystem ?? "80/20";
        const bbbeePoints = tender.eligibleBbbeePoints ?? 0;
        ...
        return new Response(body, {
          headers: {
            ...
            "content-disposition": `attachment; filename="SBD61-${tenderId}.pdf"`,
